  ...
  return (
    <div className="mb-4 mt-6 border p-3 rounded">
      <div className="form-control">
        ...
        <input key={`file-${keyGambar}`} onChange={e => handlePick(e)} type="file" className="file-input file-input-bordered w-full max-w-xs mb-2" />
       </div>
      <button className="btn btn-primary" onClick={() => clickUpload()}>{
